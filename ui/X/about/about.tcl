...
proc vTclWindow.top36 {base} {
    ...
    vTcl:toplevel $top -class Toplevel \
        -background {#d9d9d9} 
    wm focusmodel $top passive
    wm geometry $top 250x250+546+155; update
...
http://www.digitalsurvival.us} 
    vTcl:DefineAlias "$top.tLa41" "TLabel1" vTcl:WidgetProc "About" 1
    ttk::label $top.tLa42 \
        -background {#d9d9d9} -foreground {#000000} -relief flat \
        -text {Stage7 Installer GUI} 
    vTcl:DefineAlias "$top.tLa42" "TLabel2" vTcl:WidgetProc "About" 1
    ttk::label $top.tLa43 \
        -background {#d9d9d9} -foreground {#000000} -relief flat \
        -text Version: 
    vTcl:DefineAlias "$top.tLa43" "TLabel3" vTcl:WidgetProc "About" 1
    ttk::label $top.tLa45 \
        -background {#d9d9d9} -foreground {#000000} -relief flat -text Number 
    vTcl:DefineAlias "$top.tLa45" "TLabel4" vTcl:WidgetProc "About" 1
    ###################
    # SETTING GEOMETRY
    ###################
    place $top.tLa41 \
    ...
    place $top.tLa42 \
        -in $top -x 60 -y 20 -width 105 -height 19 -anchor nw \
        -bordermode ignore 
    place $top.tLa43 \
