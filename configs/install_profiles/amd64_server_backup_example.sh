# $Id$
# Created by Matthew Marchese, December 7th, 2014
...
# Example Description:
# This install profile is an example of what a generic stage4 backup script could look like.

module_import bootloader misc fetcher rescue

hostname System_Backup
